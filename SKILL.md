...
description: Generate executive-grade market research reports in KPMG/Big4 consulting style. Use this skill when the user asks for market research, market study, market analysis, market sizing, competitive landscape, industry report, sector study, country market entry, feasibility study, or business intelligence report. Triggers on phrases like "market research for [product]", "market study for [country]", "analyze the [industry] market", "research the [sector] in [country]", "feasibility of exporting [product] to [market]", "build me a market report", "I need a professional market analysis", or any request for a structured, data-driven market report. Produces both PDF (professional, branded) and interactive HTML versions in Arabic, English, or French based on user preference. Conducts live web research to gather market size, growth trends, regulatory landscape, key players, pricing, distribution channels, and consumer insights. Output mirrors the structure used by KPMG, Deloitte, McKinsey, and BCG — with executive summary, market sizing (CAGR, demand/supply), regulatory framework, competitive analysis, charts, and strategic recommendations.
license: MIT
version: 1.0.0
